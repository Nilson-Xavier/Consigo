...
//------------------------------------------------------------------------------
void TImpressoraMecaf::AbrirCupom( String* Cupom, String* &Retorno ) {
  ...
  try {
    ...
    try {
      ...
      *this->NumeroCupom = *Cupom;
      ...
      Texto->Add( "\x1B\x57\x1      CUPOM FISCAL\x1B\x57\x2\x0A\x0A" );
    ...
    *Retorno = "";
    ...
    try {
      ...
      if( StringReplace( *this->ValorTotal, ".", "", TReplaceFlags( ) << rfReplaceAll << rfIgnoreCase ).ToDouble( ) < 100 ) {
        ...
        Texto->Add( "................................................\x0A" );
        Texto->Add( "Voce esta Concorrendo a um Colete Profissional!\x0A" );
        Texto->Add( "\x0A" );

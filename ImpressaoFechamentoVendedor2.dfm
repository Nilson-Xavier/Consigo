object FormImpressaoFechamentoVendedor2: TFormImpressaoFechamentoVendedor2
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  HorzScrollBar.Position = 143
  Caption = 'Impressao do Fechamento dos Vendedores 2'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object QuickRepFechamentoVendedor: TQuickRep
    Left = -143
    Top = -1
    Width = 1191
    Height = 813
    ...
    DataSet = QueryFechamentoVendedor2
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Fechamento dos Vendedores do Dia'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
    ...
    object QRBand4: TQRBand
      ...
      object QRExprTotal: TQRExpr
        ...
        Font.Style = [fsBold]
        Color = clWhite
        Master = QuickRepFechamentoVendedor
        ParentFont = False
        ResetAfterPrint = True
        Transparent = False
        WordWrap = False
        Expression = 'FORMATNUMERIC('#39'#,##0.00'#39',SUM(QueryFechamentoVendedor2.Preco))'
        FontSize = 12
      end
      object QRLabelComissao: TQRLabel
        Left = 699
        Top = 3
        Width = 103
        Height = 20
      ...
      object QRExprComissao: TQRExpr
        ...
        WordWrap = False
        Expression = 
          'FORMATNUMERIC('#39'#,##0.00'#39',SUM(QueryFechamentoVendedor2.Preco) * C' +
          'OMISSAO) '
        FontSize = 12
      end
    end
    object QRBand5: TQRBand
      ...
      object QRExprTotalGeral: TQRExpr
        Left = 538
        Top = 10
        Width = 107
        Height = 23
    ...
    object QRGroup1: TQRGroup
      ...
      Size.Values = (
        76.7291666666667
        2950.10416666667)
      Expression = 'QueryFechamentoVendedor2.Vendedor'
      FooterBand = QRBand4
      Master = QuickRepFechamentoVendedor
      ReprintOnNewPage = False
      object QRLabelVendedor: TQRLabel
        Left = 20
        Top = 5
        Width = 82
        Height = 20
    ...
    object QRBand2: TQRBand
      ...
      object QRExprData: TQRExpr
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryFechamentoVendedor2.Data'
        FontSize = 10
      end
      object QRExprMarca: TQRExpr
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryFechamentoVendedor2.Marca'
        FontSize = 10
      end
      object QRExprNome: TQRExpr
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryFechamentoVendedor2.Nome'
        FontSize = 10
      end
      object QRExprQuantidade: TQRExpr
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryFechamentoVendedor2.Quantidade'
        FontSize = 10
      end
      object QRExprPrecoUnit: TQRExpr
        ...
        WordWrap = False
        Expression = 
          #39'R$'#39'+FORMATNUMERIC('#39'#,##0.00'#39',QueryFechamentoVendedor2.Preco / Q' +
          'ueryFechamentoVendedor2.Quantidade)'
        FontSize = 10
      end
      object QRExprPreco: TQRExpr
        ...
        Transparent = False
        WordWrap = False
        Expression = #39'R$'#39'+FORMATNUMERIC('#39'#,##0.00'#39',QueryFechamentoVendedor2.Preco)'
        FontSize = 10
      end
      object QRExprTipo: TQRExpr
        Left = 880
        Top = 1
        Width = 123
        Height = 18
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryFechamentoVendedor2.Tipo'
        FontSize = 10
      end
    end
  end
  object QueryFechamentoVendedor2: TQuery
    DatabaseName = 'CONSIGO'
    SQL.Strings = (
      'SELECT Produtos.Marca, Produtos.Nome, Vendem2.Quantidade,'
      '               Vendem2.Preco, Vendem2.Tipo, Vendem2.Data,'
      '               Vendem2.Numero_nota, Vendedores.Nome AS Vendedor'
      '  FROM Vendem2, Produtos, Vendedores'
      '  WHERE Vendem2.RG_Vendedor = Vendedores.RG'
      '  AND       Vendem2.EERG_Vendedor = Vendedores.EERG '
      '  AND       Vendem2.Codigo = Produtos.Codigo'
      '  AND       Vendem2.Data >= :DataInicial'
      '  AND       Vendem2.Data <= :DataFinal'
      '  ORDER BY Vendedor, Vendem2.Numero_nota, Vendem2.Data')
    Left = 340
    Top = 82
    ParamData = <
      item
    ...
    object QueryFechamentoVendedor2Marca: TStringField
      FieldName = 'Marca'
      Origin = 'CONSIGO.Produtos.Marca'
      FixedChar = True
      Size = 50
    end
    object QueryFechamentoVendedor2Nome: TStringField
      FieldName = 'Nome'
      Origin = 'CONSIGO.Produtos.Nome'
      FixedChar = True
      Size = 100
    end
    object QueryFechamentoVendedor2Quantidade: TIntegerField
      FieldName = 'Quantidade'
      Origin = 'CONSIGO.Vendem2.Quantidade'
    end
    object QueryFechamentoVendedor2Preco: TFloatField
      FieldName = 'Preco'
      Origin = 'CONSIGO.Vendem2.Preco'
    end
    object QueryFechamentoVendedor2Tipo: TStringField
      FieldName = 'Tipo'
      Origin = 'CONSIGO.Vendem2.Tipo'
      FixedChar = True
    end
    object QueryFechamentoVendedor2Data: TDateTimeField
      FieldName = 'Data'
      Origin = 'CONSIGO.Vendem2.Data'
    end
    object QueryFechamentoVendedor2Numero_nota: TIntegerField
      FieldName = 'Numero_nota'
      Origin = 'CONSIGO.Vendem2.Numero_nota'
    end
    object QueryFechamentoVendedor2Vendedor: TStringField
      FieldName = 'Vendedor'
      Origin = 'CONSIGO.Vendedores.Nome'
      FixedChar = True
      Size = 40
    end
  end

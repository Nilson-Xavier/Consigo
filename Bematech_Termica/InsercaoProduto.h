...
__published:	// IDE-managed Components
  ...
  TTabSheet *TabSheetEmissorCupomFiscal;
  TMenuItem *EmissorCupomFiscal1;
  ...
  TLabel *LabelTotal;
  TEdit *EditTotal;
  TLabel *LabelDescricaoProduto;
  TLabel *LabelCpfCnpjCliente;
  TEdit *EditCpfCnpjCliente;
  TLabel *LabelNomeCliente;
  TComboBox *ComboBoxDescricaoProduto;
  TComboBox *ComboBoxNomeCliente;
  TLabel *Label5;
  TComboBox *ComboBoxTipoPagamento;
  TLabel *LabelTipoPagamento;

	void __fastcall Inserao1Click(TObject *Sender);
	void __fastcall Fotos1Click(TObject *Sender);
  void __fastcall EmissorCupomFiscal1Click(TObject *Sender);
  ...
  void __fastcall BitBtnImprimirCupomFiscalClick( TObject *Sender );
  void __fastcall ComboBoxNomeVendedorKeyDown( TObject *Sender, WORD &Key,
          TShiftState Shift );
  void __fastcall ComboBoxDescricaoProdutoKeyDown(
  ...
  void __fastcall ComboBoxNomeClienteKeyDown( TObject *Sender,
      WORD &Key, TShiftState Shift );
  void __fastcall StringGridProdutosKeyDown( TObject *Sender,
      WORD &Key, TShiftState Shift );

private:	// User declarations
  TJPEGImage *JpegImage2;
  TStringList *PrecoItensComboBoxDescricaoProduto;
public:		// User declarations
	__fastcall TFormInsercaoProduto(TComponent* Owner);
  __fastcall ~TFormInsercaoProduto( void );
};
//---------------------------------------------------------------------------

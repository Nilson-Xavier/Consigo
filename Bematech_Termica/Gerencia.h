...
class TFormGerencia : public TForm {
  ...
  TBitBtn *BitBtnGerarArquivoRfd;
  TEdit *EditPastaRfd;
  TBitBtn *BitBtnOpenFolderDialog;
  TBitBtn *BitBtnOpenFileDialog;
  TEdit *EditArquivoRfd;
  TBitBtn *BitBtnValidarArquivoRfd;
  TOpenDialog *OpenDialogArquivoRfd;
  TMaskEdit *MaskEditDataRfd;
  TLabel *LabelDataRfd;
  ...
  void __fastcall BitBtnOpenFolderDialogClick( TObject *Sender );
  void __fastcall BitBtnGerarArquivoRfdClick( TObject *Sender );
  void __fastcall BitBtnOpenFileDialogClick( TObject *Sender );
  void __fastcall BitBtnValidarArquivoRfdClick( TObject *Sender );
  ...
  private:	// User declarations
    ...
    void __fastcall ListBoxConsertoVendedorKeyPress( TObject* Sender, char &Key );
    void __fastcall ListBoxConsertoClienteKeyPress( TObject* Sender, char &Key );
  ...
  public:		// User declarations
    ...
    void __fastcall DesabilitarButoesFuncoesImpressora( void );
    void __fastcall AbilitarButoesFuncoesImpressora( void );
};
//---------------------------------------------------------------------------

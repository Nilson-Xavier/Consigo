...
__fastcall TFormInsercaoProduto::TFormInsercaoProduto( TComponent* Owner )
  ...
  PrecoItensComboBoxDescricaoProduto = new TStringList( );
  PrecoItensComboBoxDescricaoProduto->Sorted = false;
}
//---------------------------------------------------------------------------
__fastcall TFormInsercaoProduto::~TFormInsercaoProduto( void ) {

  delete PrecoItensComboBoxDescricaoProduto;
}
//---------------------------------------------------------------------------
void __fastcall TFormInsercaoProduto::FormCreate( TObject *Sender ) {
  ...
  StringGridProdutos->ColCount = 5;
  StringGridProdutos->Cells[0][0] = "Produto";
  StringGridProdutos->ColWidths[0] = 590;
  StringGridProdutos->Cells[1][0] = "Qtd";
  StringGridProdutos->ColWidths[1] = 45;
  StringGridProdutos->Cells[2][0] = "Preco Unit R$";
  StringGridProdutos->ColWidths[2] = 140;
  StringGridProdutos->Cells[3][0] = "Preco Total R$";
  StringGridProdutos->ColWidths[3] = 150;
  StringGridProdutos->Cells[4][0] = "Codigo";
  StringGridProdutos->ColWidths[4] = 200;

  try {
    Query= new TConsigoQuery( &( DataModuleQuery->consigo_BD->DatabaseName ), DataModuleQuery );
    ComboBoxNomeVendedor->Items->Clear( );
    try {
      ...
      Query->First( );
      while( !Query->Eof ) {
      this->ComboBoxNomeVendedor->Items->Add( Query->FieldByName( "Nome" )->AsString );
        Query->Next( );
      }
    }
    catch( Exception &e ) {

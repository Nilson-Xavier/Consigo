object FormImpressaoEntradaProduto2: TFormImpressaoEntradaProduto2
  Left = -4
  Top = -4
  Width = 808
  Height = 580
  HorzScrollBar.Position = 2
  Caption = 'FormImpressão da Entrada dos Produtos'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object QuickRepEntradaProduto: TQuickRep
    Left = -2
    Top = 0
    Width = 813
    Height = 1191
    ...
    DataSet = QueryEntradaFornecedores
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object QRBand1: TQRBand
      ...
      object QRLabelSlogan: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '"A Certeza de um Bom Negócio"'
        Color = clWhite
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Entrada de Produtos do Dia'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
      ...
      object QRLabelDataInicial: TQRLabel
        Left = 263
        Top = 104
        Width = 99
        Height = 25
      ...
      object QRLabelDataFinal: TQRLabel
        Left = 397
        Top = 104
        Width = 99
        Height = 25
    ...
    object QRBand4: TQRBand
      ...
      object QRLabelFornecedor: TQRLabel
        Left = 4
        Top = 1
        Width = 96
        Height = 20
      ...
      object QRExprFornecedor: TQRExpr
        Left = 101
        Top = 2
        Width = 320
        Height = 19
        ...
        Font.Style = []
        Color = clWhite
        Master = QuickRepEntradaProduto
        ParentFont = False
        ResetAfterPrint = False
        Transparent = False
        WordWrap = False
        Expression = 'QueryEntradaFornecedores.Nome'
        FontSize = 12
      end
      object QRLabelNotaFiscal: TQRLabel
        Left = 422
        Top = 1
        Width = 112
        Height = 20
      ...
      object QRExprNotaFiscal: TQRExpr
        Left = 535
        Top = 2
        Width = 74
        Height = 19
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryEntradaFornecedores.Numero_nota'
        FontSize = 12
      end
      ...
      object QRExprData: TQRExpr
        ...
        WordWrap = False
        Expression = 
          'QueryEntradaFornecedores.Dia +'#39'/'#39' + QueryEntradaFornecedores.Mes' +
          '+'#39'/'#39'+QueryEntradaFornecedores.Ano'
        FontSize = 12
      end
    end
    object QRSubDetail1: TQRSubDetail
      ...
      Size.Values = (
        ...
        1949.97916666667)
      Master = QuickRepEntradaProduto
      DataSet = QueryEntradaItens
      FooterBand = QRBand2
      HeaderBand = QRBand4
      PrintBefore = False
      PrintIfEmpty = False
      object QRExprPrecoUnit: TQRExpr
        Left = 560
        Top = 1
        Width = 87
        Height = 19
        ...
        Transparent = False
        WordWrap = False
        Expression = #39'U$'#39'+FORMATNUMERIC('#39'#,##0.00'#39',QueryEntradaItens.Preco)'
        FontSize = 11
      end
      object QRExprMarca: TQRExpr
        Left = 3
        Top = 1
        Width = 158
        Height = 19
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryEntradaItens.Marca'
        FontSize = 11
      end
      object QRExprNome: TQRExpr
        Left = 163
        Top = 1
        Width = 365
        Height = 19
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryEntradaItens.Nome'
        FontSize = 11
      end
      object QRExprQuantidade: TQRExpr
        Left = 529
        Top = 1
        Width = 30
        Height = 19
        ...
        Transparent = False
        WordWrap = False
        Expression = 'QueryEntradaItens.Quantidade'
        FontSize = 11
      end
      object QRExprPreco: TQRExpr
        Left = 648
        Top = 1
        Width = 87
        Height = 19
        ...
        WordWrap = False
        Expression = 
          #39'U$'#39'+FORMATNUMERIC('#39'#,##0.00'#39',QueryEntradaItens.Quantidade * Que' +
          'ryEntradaItens.Preco)'
        FontSize = 11
      end
    end
    object QRBand2: TQRBand
      ...
      object QRExprTotal: TQRExpr
        ...
        WordWrap = False
        Expression = 
          'FORMATNUMERIC('#39'#,##0.00'#39',SUM(QueryEntradaItens.Quantidade * Quer' +
          'yEntradaItens.Preco))'
        FontSize = 11
      end
    end
  ...
  object QueryEntradaFornecedores: TQuery
    DatabaseName = 'CONSIGO'
    SQL.Strings = (
      'SELECT DISTINCT Fornecedores.Nome, Fornecedores.CGC,'
      '                                Vendem1.Numero_nota,'
      
        '                                DATEPART( dd, Vendem1.Data ) AS ' +
        'Dia,'
      
        '                                DATEPART( mm, Vendem1.Data ) AS ' +
        'Mes,'
      
        '                                DATEPART( yy, Vendem1.Data ) AS ' +
        'Ano'
      '  FROM Fornecedores, Vendem1'
      '  WHERE Vendem1.CGC = Fornecedores.CGC'
      '  AND   DATEPART( dd, Vendem1.Data ) >= :DiaI'
      '  AND   DATEPART( dd, Vendem1.Data ) <= :DiaF'
      '  AND   DATEPART( mm, Vendem1.Data ) >= :MesI'
      '  AND   DATEPART( mm, Vendem1.Data ) <= :MesF'
      '  AND   DATEPART( yy, Vendem1.Data ) >= :AnoI'
      '  AND   DATEPART( yy, Vendem1.Data ) <= :AnoF'
      '  ORDER BY Dia, Mes, Ano, Fornecedores.Nome')
    Left = 360
    Top = 80
    ParamData = <
      item
    ...
    object QueryEntradaFornecedoresNome: TStringField
      FieldName = 'Nome'
      FixedChar = True
      Size = 100
    end
    object QueryEntradaFornecedoresDia: TIntegerField
      FieldName = 'Dia'
    end
    object QueryEntradaFornecedoresMes: TIntegerField
      FieldName = 'Mes'
    end
    object QueryEntradaFornecedoresAno: TIntegerField
      FieldName = 'Ano'
    end
  end
  object QueryEntradaItens: TQuery
    DatabaseName = 'CONSIGO'
    DataSource = DataSourceEntradaFornecedores
    SQL.Strings = (
      'SELECT Produtos.Nome, Produtos.Marca, Vendem1.Quantidade, '
      '               Vendem1.Preco'
      '  FROM Produtos, Vendem1'
      '  WHERE Vendem1.CGC = :CGC'
      '  AND       Vendem1.Numero_nota = :Numero_nota'
      '  AND       Produtos.Codigo = Vendem1.Codigo'
      '  ORDER BY Vendem1.Data')
    Left = 456
    Top = 80
    ParamData = <
      item
    ...
    object QueryEntradaItensPreco: TFloatField
      FieldName = 'Preco'
      Origin = 'CONSIGO.Vendem1.Preco'
    end
    object QueryEntradaItensNome: TStringField
      FieldName = 'Nome'
      Origin = 'CONSIGO.Produtos.Nome'
      FixedChar = True
      Size = 100
    end
    object QueryEntradaItensMarca: TStringField
      FieldName = 'Marca'
      Origin = 'CONSIGO.Produtos.Marca'
      FixedChar = True
      Size = 50
    end
    object QueryEntradaItensQuantidade: TIntegerField
      FieldName = 'Quantidade'
      Origin = 'CONSIGO.Vendem1.Quantidade'
    end
  end
  object DataSourceEntradaFornecedores: TDataSource
    DataSet = QueryEntradaFornecedores
    Left = 408
    Top = 80
  end
